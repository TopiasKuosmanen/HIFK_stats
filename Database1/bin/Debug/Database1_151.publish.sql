...
GO
PRINT N'The following operation was generated from a refactoring log file 4db917d8-2bd9-4da5-97e2-b494453b4d20';

PRINT N'Rename [dbo].[League].[League] to LeagueName';


GO
EXECUTE sp_rename @objname = N'[dbo].[League].[League]', @newname = N'LeagueName', @objtype = N'COLUMN';
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '4db917d8-2bd9-4da5-97e2-b494453b4d20')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('4db917d8-2bd9-4da5-97e2-b494453b4d20')
