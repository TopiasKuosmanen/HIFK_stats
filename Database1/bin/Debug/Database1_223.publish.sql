...
GO
PRINT N'Creating [dbo].[FK_Stats_League]...';


GO
ALTER TABLE [dbo].[Stats] WITH NOCHECK
    ADD CONSTRAINT [FK_Stats_League] FOREIGN KEY ([LeagueId]) REFERENCES [dbo].[League] ([Id]);
...
GO
ALTER TABLE [dbo].[Stats] WITH CHECK CHECK CONSTRAINT [FK_Stats_League];
