...
GO
PRINT N'Creating [dbo].[DeleteGame]...';
...
BEGIN
	...
	BEGIN
		DELETE FROM [2020Veikkausliigastats] WHERE GameId = @GameId
	END
	IF @League = 'Suomen Cup'
	BEGIN
		DELETE FROM [2020Suomencupstats] WHERE GameId = @GameId
	END
	IF @League = 'Friendly'
	BEGIN
		DELETE FROM [2020Friendlystats] WHERE GameId = @GameId
	END
END
GO
