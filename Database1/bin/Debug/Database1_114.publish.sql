...
GO
PRINT N'Dropping [dbo].[FK_Game_Opponent]...';


GO
ALTER TABLE [dbo].[Game] DROP CONSTRAINT [FK_Game_Opponent];


GO
PRINT N'Creating [dbo].[FK_Opponent_Game]...';


GO
ALTER TABLE [dbo].[Opponent] WITH NOCHECK
    ADD CONSTRAINT [FK_Opponent_Game] FOREIGN KEY ([Id]) REFERENCES [dbo].[Game] ([Id]);
...
GO
ALTER TABLE [dbo].[Opponent] WITH CHECK CHECK CONSTRAINT [FK_Opponent_Game];
