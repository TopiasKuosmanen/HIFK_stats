...
GO
PRINT N'Creating unnamed constraint on [dbo].[PlayersNationality]...';


GO
ALTER TABLE [dbo].[PlayersNationality]
    ADD PRIMARY KEY CLUSTERED ([PlayerId] ASC);


GO
PRINT N'Creating unnamed constraint on [dbo].[Playersposition]...';


GO
ALTER TABLE [dbo].[Playersposition]
    ADD PRIMARY KEY CLUSTERED ([PlayerId] ASC);
