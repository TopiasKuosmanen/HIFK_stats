...
GO
PRINT N'Altering [dbo].[GetPlayersNationalities]...';


GO
ALTER PROCEDURE [dbo].[GetPlayersNationalities]
	@Id INT
AS
BEGIN
...
END
GO
PRINT N'Altering [dbo].[GetPlayersPositions]...';


GO
ALTER PROCEDURE [dbo].[GetPlayersPositions]
	@Id INT
AS
BEGIN
	SELECT P.Position
