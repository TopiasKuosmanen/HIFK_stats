...
BEGIN
	INSERT INTO [2020Veikkausliigastats] (PlayerId, GameId) 
	VALUES (@PlayerId, @GameId)
END
IF @League = 'Suomen Cup'
BEGIN
	INSERT INTO [2020Suomencupstats] (PlayerId, GameId) 
	VALUES (@PlayerId, @GameId)
END
IF @League = 'Friendly'
BEGIN
	INSERT INTO [2020Friendlystats] (PlayerId, GameId) 
	VALUES (@PlayerId, @GameId)
END
GO
PRINT N'Creating [dbo].[AddStatsByGameId]...';
