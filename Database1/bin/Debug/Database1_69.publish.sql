...
ALTER VIEW [dbo].[TotalStats2020]
	AS 
	SELECT (F.PlayerId + S.PlayerId + V.PlayerId) AS PlayerId, (F.Goals + S.Goals + V.Goals) AS Goals, 
	...
	JOIN [2020Veikkausliigastats] V ON S.PlayerId = V.PlayerId 
	GROUP BY F.PlayerId, S.PlayerId, V.PlayerId
GO
