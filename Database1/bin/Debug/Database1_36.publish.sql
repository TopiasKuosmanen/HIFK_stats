...
GO
ALTER TABLE [dbo].[Player] ALTER COLUMN [BirthDate] DATE NOT NULL;
...
GO
ALTER TABLE [dbo].[Staff] ALTER COLUMN [BirthDate] DATE NULL;
...
ALTER VIEW [dbo].[Person]
	AS SELECT p.FirstName, p.LastName, FLOOR((CAST (GetDate() AS INTEGER) - CAST(p.BirthDate AS INTEGER)) / 365.25) AS Age
	FROM dbo.Player p
	UNION
