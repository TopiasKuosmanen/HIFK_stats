...
GO
PRINT N'Dropping [dbo].[FK_Opponent_Game]...';


GO
ALTER TABLE [dbo].[Opponent] DROP CONSTRAINT [FK_Opponent_Game];


GO
PRINT N'Creating [dbo].[FK_Game_Opponent]...';


GO
ALTER TABLE [dbo].[Game] WITH NOCHECK
    ADD CONSTRAINT [FK_Game_Opponent] FOREIGN KEY ([Id]) REFERENCES [dbo].[Opponent] ([Id]);
...
GO
ALTER TABLE [dbo].[Game] WITH CHECK CHECK CONSTRAINT [FK_Game_Opponent];
