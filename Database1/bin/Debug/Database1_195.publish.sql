...
GO
PRINT N'Altering [dbo].[FriendlyGames]...';


GO
ALTER VIEW [dbo].[FriendlyGames]
	AS 
...
GO
PRINT N'Altering [dbo].[SuomencupGames]...';


GO
ALTER VIEW [dbo].[SuomencupGames]
	AS 
	SELECT g.Id, g.DateTime, g.Serie, g.Result, g.Stadion, g.Home_match, o.Team AS 'Opponent'
	FROM Game g JOIN Opponent o ON g.OpponentId = o.Id
	WHERE g.Serie = 'Suomen Cup'
GO
PRINT N'Altering [dbo].[VeikkausliigaGames]...';


GO
ALTER VIEW [dbo].[VeikkausliigaGames]
	AS 
	SELECT g.Id, g.DateTime, g.Serie, g.Result, g.Stadion, g.Home_match, o.Team AS 'Opponent'
	FROM Game g JOIN Opponent o ON g.OpponentId = o.Id
