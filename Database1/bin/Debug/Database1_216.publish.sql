...
GO
PRINT N'Altering [dbo].[AddPlayersNationality]...';


GO
ALTER PROCEDURE [dbo].[AddPlayersNationality]
	@PlayerId INT,
...
END
GO
PRINT N'Altering [dbo].[AddPlayersPosition]...';


GO
ALTER PROCEDURE [dbo].[AddPlayersPosition]
	@PlayerId INT,
