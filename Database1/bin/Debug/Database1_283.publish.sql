...
AS
BEGIN
	SELECT o.Team AS Opponent, g.OpponentId, g.DateTime, DATENAME(WEEKDAY, g.DateTime) AS WeekDay, g.Serie, g.Result, g.Stadion, g.Home_match, g.ResultCode, g.Attendance, g.RefereeId
