...
GO
PRINT N'Dropping [dbo].[FK_PlayersNationality_Player]...';


GO
ALTER TABLE [dbo].[PlayersNationality] DROP CONSTRAINT [FK_PlayersNationality_Player];


GO
PRINT N'Dropping [dbo].[FK_Playersposition_Player]...';


GO
ALTER TABLE [dbo].[Playersposition] DROP CONSTRAINT [FK_Playersposition_Player];
