...
GO
PRINT N'Creating [dbo].[GetStatsWithParameters]...';
...
BEGIN
	...
	WHERE g.DateTime >= @StartingDay AND g.DateTime <= @EndingDay AND P.LastName LIKE '%' + @Player + '%' OR P.FirstName LIKE '%' + @Player + '%'
